...
const serkom = {
  "serkom-skkni-muk": {
    ...
    coverage: [
      "Materi latihan digunakan untuk pembelajaran dan simulasi, sedangkan keputusan kompeten atau belum kompeten tetap mengikuti asesor dan LSP.",
  ...
  "serkom-cheatsheet": {
    ...
    coverage: [
      ...
      "Latihan dianjurkan diulang sampai peserta mampu menyelesaikan proyek tanpa bergantung pada potongan kode lengkap.",
      "Landasan teknis mencakup SKKNI 282 Tahun 2016, dokumentasi Laravel 12, serta perangkat MUK yang berlaku."
    ]
  }
};

const curriculum = { ...math, ...indonesian, ...english, ...serkom };

export function getCurriculumCoverage(topicId) {
  const item = curriculum[topicId];
  if (!item) return { learningCompetency: "", learningCoverage: [] };
  return {
    learningCompetency: item.competency,
    learningCoverage: item.coverage
  };
}
