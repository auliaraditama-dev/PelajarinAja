...
const facts = {
  "serkom-skkni-muk": [
    ["status jobsheet", "Jobsheet berfungsi sebagai bahan pembelajaran dan simulasi; keputusan kompeten resmi tetap mengikuti asesor, LSP, skema, dan MUK yang disahkan.", ["Jobsheet otomatis menjadi sertifikat kompetensi resmi.", "Nilai latihan selalu menggantikan keputusan asesor.", "Jobsheet dapat mengubah MUK resmi tanpa validasi LSP."]],
    ["J.620100.033.02", "Unit tersebut berkaitan dengan pelaksanaan pengujian unit program dan disebut langsung pada MUK sekolah yang dipelajari dalam jobsheet.", ["Unit tersebut khusus mengatur desain logo.", "Unit tersebut hanya membahas pemasangan jaringan fisik.", "Unit tersebut menghapus kebutuhan pengujian aplikasi."]],
  ...
  "serkom-css": [
    ...
    ["fokus penilaian UI", "Dalam jobsheet, keterbacaan, konsistensi, fungsi, dan responsivitas lebih penting daripada kompleksitas desain.", ["UI dinilai hanya dari jumlah animasi.", "Semakin banyak efek selalu berarti kompetensi lebih tinggi.", "Fungsi CRUD tidak perlu bekerja jika desain menarik."]]
  ],
  "serkom-workflow": [
