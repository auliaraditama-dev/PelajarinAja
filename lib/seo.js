...
export function subjectMetadata(subject) {
  ...
  const description = normalizeText(`${subject.description} Pelajari materi terstruktur, kerjakan 25 soal bervariasi dengan format pilihan ganda dan pilihan ganda kompleks, lalu pantau nilai kemampuan di PelajarinAja.`);
